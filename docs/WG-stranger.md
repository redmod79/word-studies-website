...
|----------|------|-----------------|-----|-------------|-----------------|---------------|
| H1616 | גֵּר | ger | m. noun | 83 | The resident alien with full legal rights and obligations | [H1616-ger.md](H1616-ger.md) |
...
| H3490 | יָתוֹם | yathom | m. noun | 42 | Fatherless, orphan — co-member of the welfare triad | TODO(need H3490 study) |
...
|--------|--------|---------------|-----------------|
| almanah / yathom | (each other) | 30 | "widow and fatherless" — protective legislation |
| ger / gur | | 22 | "the stranger that sojourneth" — formulaic modifier |
| ger / almanah | | 18 | "stranger, fatherless, and widow" — welfare triad |
| ger / yathom | | 18 | Same triad |
...
|-------------|-------------|-------|
| ger + gur + ezrach | all → προσήλυτος in many LXX contexts | Greek conflates the ger/ezrach distinction |
| ger + toshab | both → πάροικος in some contexts | Greek treats both as "dwelling near" |
...
- **The Integrated Resident:** ger (גֵּר) — a non-Israelite who lives permanently under Israelite law with rights and obligations
- **The Activity:** gur (גּוּר) — the verb "to sojourn," defining what the ger does
...
- **Exo 12:48–49** — [ger + gur + ezrach] Passover law: circumcised ger keeps it; "one law for homeborn and stranger"
- **Lev 16:29** — [ger + gur + ezrach] Day of Atonement: native and ger both afflict their souls
- **Lev 19:33–34** — [ger + gur + ezrach] "love him as thyself... as one born among you"
- **Deu 10:18–19** — [ger + almanah + yathom] God "loveth the stranger... Love ye therefore the stranger"
- **Deu 24:19–21** — [ger + almanah + yathom] Gleaning laws: harvest leftovers "shall be for the stranger, fatherless, and widow" (3x)
- **Deu 27:19** — [ger + almanah + yathom] "Cursed be he that perverteth the judgment of the stranger, fatherless, and widow"
- **Eze 47:22** — [ger + gur + ezrach] Eschatological land inheritance extended to the ger "as born in the land"
- **Jer 7:6** — [ger + almanah + yathom] "if ye oppress not the stranger, the fatherless, and the widow"
